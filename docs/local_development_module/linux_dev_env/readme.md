...
| Combo | Action |
|-------|--------|
| `<C-h/j/k/l>` | ⬅️⬇️⬆️➡️ Navigate between tmux panes |
...
| `/` | 🔍 Search forward |
| `?` | 🔍 Search backward |
| `n/N` | ⏭️⏮️ Next/Previous search result |
| `<leader>S` | 🔄 Find and replace across project |
...
| `<leader>ca` | 🛠️ Code actions |
| `<leader>r` | ✏️ Rename symbol |
...
| `[d/]d` | ⬆️⬬️ Next/Previous diagnostic |
